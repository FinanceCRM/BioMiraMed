...
export default function IntraArticularPage() {
  ...
  const products = [
    {
      name: "Joint Smooth",
      description: "Pürüzsüz intraartiküler enjeksiyon için optimize edilmiş viskozite.",
      tag: "Düşük Kuvvet",
    ...
    {
      name: "Stability Max",
      description: "Sürekli eklem fonksiyonunu desteklemek için formülasyon stabilitesi.",
      tag: "Stabil",
    ...
    {
      name: "Comfort Plus",
      description: "Azaltılmış enjeksiyon kuvveti ve hasta konforu için tasarlanmıştır.",
      tag: "Konfor",
        ...
        <div className="container-max px-4">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
              {t("products.detail.intraArticular.description")}
              ileri eklem enjeksiyonu çözümleri.
            </p>
          </div>
